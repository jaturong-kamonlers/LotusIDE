// ============================================================
// Motor helpers for LotusDueBot
// 6 motors total (TB6612FNG x3 - each has 2 channels)
// Index mapping (matches block "Motor 1..6"):
//   M1 = TB1-A  (M1A=D37, M1B=D36, PWM1=D3)
//   M2 = TB1-B  (M2A=D35, M2B=D34, PWM2=D2)
//   M3 = TB2-A  (M3A=D40, M3B=D41, PWM3=D6)
//   M4 = TB2-B  (M4A=D39, M4B=D38, PWM4=D5)
//   M5 = TB3-A  (M5A=D44, M5B=D45, PWM5=D8)
//   M6 = TB3-B  (M6A=D43, M6B=D42, PWM6=D7)
// ============================================================
#ifndef _LDB_NANO_MOTOR_H_
#define _LDB_NANO_MOTOR_H_
