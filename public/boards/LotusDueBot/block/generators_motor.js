...
Blockly.JavaScript['Lotus_motor_4ch'] = function(block) {
  var speedL = block.getFieldValue('speedL') || '0';
  var speedR = block.getFieldValue('speedR') || '0';
  return 'motor_4ch(' + speedL + ', ' + speedR + ');\n';
};

Blockly.JavaScript['Lotus_motor_2ch'] = function(block) {
  var speedL = block.getFieldValue('speedL') || '0';
  var speedR = block.getFieldValue('speedR') || '0';
  return 'motor_2ch(' + speedL + ', ' + speedR + ');\n';
};

Blockly.JavaScript['Lotus_motor_single'] = function(block) {
  var idx = block.getFieldValue('MIDX');
  var speed = block.getFieldValue('speed') || '0';
  return 'motor_single(' + idx + ', ' + speed + ');\n';
};
