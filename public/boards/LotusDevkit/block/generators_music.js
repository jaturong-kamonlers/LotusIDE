...
// IMPORTANT: SOUND_PWM_CHANNEL=0, Servo uses ch2,3,4 via ESP32Servo to avoid PWM noise conflict
...
void tone(int pin, int frequency, int duration) {
  ...
  ledcDetachPin(pin); // Release pin after tone to prevent PWM bleed into servo channels
}
#END
  `;
    return code;
