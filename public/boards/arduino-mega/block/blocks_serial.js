...
Blockly.Blocks['serial_usb_init'] = {
  init: function() {
    this.appendDummyInput()
        .appendField("Initial Serial port")
        .appendField(new Blockly.FieldDropdown([["Serial","Serial"], ["Serial1","Serial1"], ["Serial2","Serial2"]]), "type");
    this.appendDummyInput()
...
Blockly.Blocks['serial_write_newline'] = {
  init: function() {
    this.appendDummyInput()
        .appendField("Serial write new line port")
        .appendField(new Blockly.FieldDropdown([["Serial","Serial"], ["Serial1","Serial1"], ["Serial2","Serial2"]]), "type");
    this.setInputsInline(true);
    this.setPreviousStatement(true, null);
    this.setNextStatement(true, null);
