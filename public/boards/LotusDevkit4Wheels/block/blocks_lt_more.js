...
Blockly.Blocks["blynk_iot_connected"] = {
  ...
  Blockly.Blocks['lt_mqtt_begin'] = {
    init: function() {
      ...
      this.setTooltip('ตั้งค่าและเชื่อมต่อ MQTT Broker');
    }
  };
  ...
  Blockly.Blocks['lt_mqtt_publish'] = {
    init: function() {
      ...
      this.setNextStatement(true, null);
      this.setColour(C_MQTT);
      this.setTooltip('ส่งข้อมูลไปยัง MQTT Broker');
    }
  };
  ...
  Blockly.Blocks['lt_mqtt_subscribe'] = {
    init: function() {
      ...
      this.setNextStatement(true, null);
      this.setColour(C_MQTT);
      this.setTooltip('สมัครรับข้อมูลจาก MQTT Topic');
    }
  };
  ...
  Blockly.Blocks['lt_mqtt_on_message'] = {
    init: function() {
      ...
      this.appendStatementInput('DO').setCheck(null);
      this.setColour(C_MQTT);
      this.setTooltip('ทำงานเมื่อได้รับข้อมูล MQTT');
    }
  };
  ...
  Blockly.Blocks['lt_mqtt_msg_topic'] = {
    init: function() {
      ...
      this.setOutput(true, 'String');
      this.setColour(C_MQTT);
      this.setTooltip('Topic ของข้อความ MQTT ล่าสุด');
    }
  };
  ...
  Blockly.Blocks['lt_mqtt_msg_payload'] = {
    init: function() {
      ...
      this.setOutput(true, 'String');
      this.setColour(C_MQTT);
      this.setTooltip('Payload ของข้อความ MQTT ล่าสุด');
    }
  };
  ...
  Blockly.Blocks['lt_mqtt_connected'] = {
    init: function() {
      ...
      this.setOutput(true, 'Boolean');
      this.setColour(C_MQTT);
      this.setTooltip('true ถ้าเชื่อมต่อ MQTT Broker สำเร็จ');
    }
  };
